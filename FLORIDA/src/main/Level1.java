...
public class Level1 {
	...
	Monster test = new Monster(6, 1, "The Formidable Test", null, 100, resist);
...
//		System.out.println(player.getDamageBonusAll()); testing porpoises
...
//		System.out.println(player.getDamageBonusAll());
